          ...
          <div className="grid md:grid-cols-2 gap-4 p-6 rounded-lg relative
            ...
            {courses.map((course, idx) => (
              <div key={idx} className="flex items-baseline space-x-3">
                ...
                <span className="text-[16px] text-gray-300 flex-1">{course}</span>
              </div>
            ))}
          </div>
        </motion.div>
          ...
          <div className="p-8 backdrop-blur-sm relative">
            ...
            <div className="space-y-6">
              <div className="text-center">
                <h3 className="text-[28px] font-bold bg-gradient-to-r from-purple-400 to-fuchsia-500 
                             bg-clip-text text-transparent">
                  {edu.institution}
                </h3>
                {edu.location && (
                  <p className="text-[16px] text-gray-400 mt-1">{edu.location}</p>
                )}
              </div>
              ...
              <div className="relative">
                ...
                <div className="pt-6">
                  <p className="text-[20px] text-gray-200 text-center">{edu.degree}</p>
                  <div className="flex justify-center items-center gap-8 mt-3">
                    <p className="text-[16px] text-amber-400">CGPA: {edu.cgpa}</p>
                    <div className="w-1 h-1 rounded-full bg-amber-400/50"></div>
                    <p className="text-[16px] text-gray-400">{edu.date}</p>
                  </div>
                </div>
              </div>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="inline-block relative w-fit mx-auto">
            ...
            <h2 className="text-[32px] font-bold tracking-[0.2em] text-amber-400 mt-4">
              Education
            </h2>
          </div>
        </motion.div>
