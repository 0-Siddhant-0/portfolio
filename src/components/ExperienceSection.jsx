      ...
      <div className="max-w-5xl mx-auto px-4 relative">
        ...
        >
          ...
          <div className="inline-block relative">
            ...
            <h2 className="text-[40px] font-bold tracking-wide px-16">
              ...
              >
                ...
                <div className="relative group">
                  <div className="bg-[#1a1a1a]/80 backdrop-blur-sm rounded-lg p-8 
                    ...
                    {/* Header */}
                    <div className="mb-6">
                      <h3 className="text-[28px] font-bold text-[#FF6B6B] mb-3 
                    ...
                    <div className="mb-6">
                      <div className="flex flex-wrap gap-2">
                        {exp.tech.split(', ').map((tech, idx) => (
                          <span 
                            key={idx}
                            className="px-4 py-1.5 text-[16px] rounded-full bg-[#40E0D0]/10 
                    ...
                    <ul className="space-y-4">
                      {exp.points.map((point, idx) => (
                        <li key={idx} className="flex items-start gap-4 group/item">
                          ...
                          />
                          <span className="text-gray-300 leading-relaxed text-[18px]">
                            {point}
                          </span>
                        </li>
                      ))}
